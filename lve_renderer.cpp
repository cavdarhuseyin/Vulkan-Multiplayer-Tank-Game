...
namespace lve {
    ...
    void LveRenderer::createCommandBuffers() {
        ...
        alloc.commandPool = lveDevice.getCommandPool();
        alloc.commandBufferCount = static_cast<uint32_t>(commandBuffers.size());

        if (vkAllocateCommandBuffers(lveDevice.device(), &alloc, commandBuffers.data()) != VK_SUCCESS) {
    ...
    VkCommandBuffer LveRenderer::beginFrame() {
        ...
        VkResult result = lveSwapChain->acquireNextImage(&currentImageIndex); // dikkat
