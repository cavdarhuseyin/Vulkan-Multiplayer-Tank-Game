...
namespace lve {
    ...
    void FirstApp::run() {
        ...
        if (gameObjects.find(sightId) != gameObjects.end()) gameObjects.at(sightId).textureDescriptorSet = sightTextureSet;
        ...
        while (!lveWindow.shouldClose()) {
            ...
            // Serbest kameradaysak normal kamera kontrolü çalýþsýn
            if (!fpsMode) {
