...
namespace lve {
    ...
    void PointLightSystem::render(FrameInfo& frameInfo){
        ...
        for (auto& kv : frameInfo.gameObjects) {
			...
			float disSquared = glm::dot(offset, offset); //length squared
		...
		// itirate through sorted lights in reverse order (furthest first)
        for (auto it = sorted.rbegin(); it != sorted.rend(); ++it ) {
            // use game obj id to find out light obj
